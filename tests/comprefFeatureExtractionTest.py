...
testComprefs = ob.may2014.list[20:60:6] + ob.monsoon[20:40:6] + ob.march2014.list[20:40:6] +\
               ob.kongrey.list[20:40:6]
...
for a in testComprefs: 
    ...
    pickle.dump(res, open(outputFolder+ 'feature_classification' + str(time.time())+ a.name + '.pydump' ))
    t1 = time.time()
