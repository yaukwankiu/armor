...
testName    = "modifiedMexicanHatTest14"
...
march2014wrf.fix()
#sigmas  = [1, 2, 4, 5, 8 ,10 ,16, 20, 32, 40, 64, 80, 128, 160, 256, 320, 512]  #2014-05-07
sigmas  = [1, 2, 4, 5, 8 ,10 ,16, 20, 32, 40, 64, 80, 128, 160]
kongrey.list    = [v for v in kongrey.list if v.dataTime>="20130829.2150"]  #hack
...
for ds in dbzstreams:
    ...
    for a in ds:
        ...
        for sigma in sigmas:
            ...
            ###############################################################################
            #   computing the numerical spectrum, i.e. sigma for which the LOG has max response
            #   2014-05-02
        ...
        a_LOGspec     = a.copy()
        a_LOGspec.name= a.name + "Laplacian-of-Gaussian_numerical_spectrum"
