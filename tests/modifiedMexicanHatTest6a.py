...
dataFolder  = dp.root + "labLogs/2014-5-2-modifiedMexicanHatTest6/"
...
ds  = DS(dataFolder=dataFolder,
             ...
             outputFolder="",
             imageFolder="",
             key1="kongrey2013",               # keywords to pick out specific files
             key2="LOGspec.dat",
             key3="", #safety check
             preload=False,
...
for dbzpattern in ds:
    ...
    histogramName   = "kongrey" + dbzpattern.dataTime  + "_LOGspec_histogram"+ ds.imageExtension
